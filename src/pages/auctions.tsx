...
const Auctions = () => {
  return (
    <div>
        <h6 className="mx-16 my-8 font-bold font-satoshi">Here&rsquo;s an overview of products actively on auction, explore!</h6>
        <div className="ml-16">
          <Auctionswiper/>
        </div>
        <section className="m-16  flex flex-col gap-y-8">
            <h5 className="font-satoshi font-bold text-2xl">Top bids from popular creators</h5>
                    ...
                    bids.map(({img,creator,date,highestbid,currentbid,name},i)=>
                        <div key={i} className="flex flex-col gap-6">
                          ...
                          <div className="flex items-center justify-between bg-[#F6F4F4] p-4">
                            ...
                            <Button classname=" bg-[#272727] px-16 py-4 text-white border border-dark ">Place bid</Button>
                          </div>
                        </div>
                    )
                }
